 ...
 * \sa am_lpc82x_hwconfig_usart0.c
 * 
 * \internal
...
/**
 * \addtogroup am_lpc82x_if_hwconfig_src_usart0
 * \copydoc am_lpc82x_hwconfig_usart0.c
 * @{
 */
...
/** \brief USART0 设备信息 */
static const am_lpc82x_usart_devinfo_t __g_usart0_devinfo = {
...
static am_lpc82x_usart_dev_t  __g_usart0_dev;    /**< \brief 定义USART0 设备  */
    
/** \brief UART0 实例初始化，获得ADC标准服务句柄 */
am_uart_handle_t am_lpc82x_usart0_inst_init (void)
{
    return am_lpc82x_usart_init(&__g_usart0_dev, &__g_usart0_devinfo);
}
