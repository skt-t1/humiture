 ...
 * \sa am_lpc82x_hwconfig_usart2.c
 * 
 * \internal
...
/**
 * \addtogroup am_lpc82x_if_hwconfig_src_usart2
 * \copydoc am_lpc82x_hwconfig_usart2.c
 * @{
 */
...
static void __lpc82x_plfm_usart2_init (void)
{
    ...
    am_gpio_pin_cfg(PIO0_28, PIO_FUNC_U2_RXD);
}
...
/** \brief USART2 设备信息 */
static const am_lpc82x_usart_devinfo_t __g_usart2_devinfo = {
...
static am_lpc82x_usart_dev_t  __g_usart2_dev;    /**< \brief 定义USART2 设备  */
    
/** \brief UART2 实例初始化，获得ADC标准服务句柄 */
am_uart_handle_t am_lpc82x_usart2_inst_init (void)
{
    return am_lpc82x_usart_init(&__g_usart2_dev, &__g_usart2_devinfo);
}
