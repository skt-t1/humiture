...
/**
 * \addtogroup am_lpc82x_if_hwconfig_src_wwdt
 * \copydoc am_lpc82x_hwconfig_wwdt.c
 * @{
 */
...
/** \brief WWDT 设备信息 */
static const am_lpc82x_wwdt_devinfo_t  __g_wwdt_devinfo = {
...
/** \brief WWDT设备实例  */
static am_lpc82x_wwdt_dev_t __g_wwdt_dev;
...
{
    return am_lpc82x_wwdt_init(&__g_wwdt_dev, &__g_wwdt_devinfo);
}
