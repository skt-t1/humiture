 ...
 * \sa am_lpc82x_hwconfig_sct0_timing.c
 * 
 * \internal
...
/**
 * \addtogroup am_lpc82x_if_hwconfig_src_sct0_timing
 * \copydoc am_lpc82x_hwconfig_sct0_timing.c
 * @{
 */
...
/** \brief SCT 设备信息 */
static const am_lpc82x_sct_timing_devinfo_t  __g_sct0_timing_devinfo = {
    LPC82X_SCT0_BASE,                 /**< \brief SCT0寄存器块的基地址 */
    AM_LPC82X_SCT_TIMING_2_16BIT,     /**< \brief SCT用于2个16-bit定时器 */
...
/** \brief SCT设备定义  */
static am_lpc82x_sct_timing_dev_t  __g_sct0_timing_dev;

/** \brief SCT0 Timer 实例初始化，获得Timer标准服务句柄 */
am_timer_handle_t am_lpc82x_sct0_timing_inst_init (void)
{
    return am_lpc82x_sct_timing_init(&__g_sct0_timing_dev,
...
{
    am_lpc82x_sct_timing_deinit(handle);
}
