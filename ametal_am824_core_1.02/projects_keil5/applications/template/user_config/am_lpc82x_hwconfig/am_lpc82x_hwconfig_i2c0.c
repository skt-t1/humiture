...
/**
 * \addtogroup am_lpc82x_if_hwconfig_src_i2c0
 * \copydoc am_lpc82x_hwconfig_i2c0.c
 * @{
 */
 ...
 * \brief I2C0 设备信息
 */
static const am_lpc82x_i2c_devinfo_t __g_i2c0_devinfo = {
...
static am_lpc82x_i2c_dev_t __g_i2c0_dev; /**< \brief I2C0 设备实例  */


/** \brief I2C0 实例初始化，获得I2C标准服务句柄 */
am_i2c_handle_t am_lpc82x_i2c0_inst_init (void)
{
    return am_lpc82x_i2c_init(&__g_i2c0_dev, &__g_i2c0_devinfo);
}
