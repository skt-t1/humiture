...
/**
 * \addtogroup am_lpc82x_if_hwconfig_src_i2c3
 * \copydoc am_lpc82x_hwconfig_i2c3.c
 * @{
 */
...
static void __lpc82x_i2c3_plfm_init (void)
{
     ...
     */
    am_gpio_pin_cfg(PIO0_6, PIO_FUNC_I2C3_SCL);
    am_gpio_pin_cfg(PIO0_7, PIO_FUNC_I2C3_SDA);
 ...
 * \brief I2C3 设备信息
 */
static const am_lpc82x_i2c_devinfo_t __g_i2c3_devinfo = {
...
static am_lpc82x_i2c_dev_t __g_i2c3_dev; /**< \brief I2C3 设备实例          */


/** \brief I2C3 实例初始化，获得I2C标准服务句柄 */
am_i2c_handle_t am_lpc82x_i2c3_inst_init (void)
{
    return am_lpc82x_i2c_init(&__g_i2c3_dev, &__g_i2c3_devinfo);
}
