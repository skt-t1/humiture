...
#ifndef __AM_LPC82X_WKT_H
#define __AM_LPC82X_WKT_H

#include "am_timer.h"
#include "amhw_lpc82x_wkt.h"
...
/**
 * \addtogroup am_lpc82x_if_wkt
 * \copydoc am_lpc82x_wkt.h
 * @{
 */
...
} am_lpc82x_wkt_devinfo_t;


/**
 * \brief WKT设备
 */
typedef struct am_lpc82x_wkt_dev {
